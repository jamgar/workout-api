...
RSpec.describe 'Exercise API' do
  ...
  describe 'GET /workouts/:workout_id/exercises/:id' do
    before { get "/workouts/#{workout_id}/exercises/#{id}" }
  ...
  describe 'POST /workouts/:workout_id/exercises' do
    let(:valid_attributes) { { name: '5x100s' } }
    ...
    context 'when an invalid request' do
      before { post "/workouts/#{workout_id}/exercises", params: {} }
  ...
  describe 'PUT /workouts/:workout_id/exercises/:id' do
    let(:valid_attributes) { { name: '5x400s' } }

    before { put "/workouts/#{workout_id}/exercises/#{id}", params: valid_attributes }
  ...
  describe 'DELETE /workouts/:workout_id/exercises/:id' do
    before { delete "/workouts/#{workout_id}/exercises/#{id}" }
